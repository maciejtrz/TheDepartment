...
public class AddBuildings {
    ...
    public void test() {
       ...
       /* TEST CODE !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */
        ...
        factory.getLabs().build(playerName, 7);
        factory.getStudentUnion().build(playerName, 6);
        ...
        factory.getLabs().upgrade(playerName, 7);
        factory.getLabs().upgrade(playerName, 7);
        factory.getLecturerRoom().upgrade(playerName, 11);
        factory.getLecturerRoom().upgrade(playerName, 11);
        factory.getPdhOffice().upgrade(playerName, 9);
        factory.getPdhOffice().upgrade(playerName, 9);

        factory.getProfOffice().upgrade(playerName, 10);
        factory.getProfOffice().upgrade(playerName, 10);
        factory.getProfOffice().upgrade(playerName, 10);
